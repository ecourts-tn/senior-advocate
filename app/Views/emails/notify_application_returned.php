...
<head>
    <meta charset="UTF-8">
    <title>Application returned for correction</title>
</head>
...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid #d9d2c5;border-radius:6px;padding:24px;">
    ...
    <?php if (! empty($viewUrl)): ?>
        <p>
            <a href="<?= esc($viewUrl) ?>" style="display:inline-block;background:#0f2340;color:#fff;text-decoration:none;padding:10px 16px;border-radius:4px;">
                Open application
            </a>
        </p>
    <?php endif; ?>
